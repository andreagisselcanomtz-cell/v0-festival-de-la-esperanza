...
function CountdownTimer({ targetDate }: { targetDate: Date }) {
  ...
  return (
    <div className="bg-gradient-to-r from-orange-400 to-yellow-400 text-white p-12 rounded-3xl shadow-2xl mb-8 transform hover:scale-105 transition-transform duration-300">
      <h3 className="text-5xl font-bold mb-8 text-center animate-pulse">¡Faltan solo!</h3>
      <div className="grid grid-cols-4 gap-8 text-center">
        <div className="bg-white/20 rounded-xl p-6 backdrop-blur-sm">
          <div className="text-6xl font-bold text-center">{timeLeft.days}</div>
          <div className="text-2xl text-center">Días</div>
        </div>
        <div className="bg-white/20 rounded-xl p-6 backdrop-blur-sm">
          <div className="text-6xl font-bold text-center">{timeLeft.hours}</div>
          <div className="text-2xl text-center">Horas</div>
        </div>
        <div className="bg-white/20 rounded-xl p-6 backdrop-blur-sm">
          <div className="text-6xl font-bold text-center">{timeLeft.minutes}</div>
          <div className="text-2xl text-center">Min</div>
        </div>
        <div className="bg-white/20 rounded-xl p-6 backdrop-blur-sm">
          <div className="text-6xl font-bold text-center">{timeLeft.seconds}</div>
          <div className="text-2xl text-center">Seg</div>
        </div>
      </div>
    </div>
  )
...
function HopeQuote({ quote, author, className = "" }: { quote: string; author?: string; className?: string }) {
  return (
...
function SectionDivider({ variant = "wave" | "diagonal" }: { variant?: "wave" | "diagonal" }) {
  if (variant === "diagonal") {
    return (
      <div className="relative h-16 overflow-hidden">
        <div className="absolute inset-0 transform -skew-y-1" style={{ backgroundColor: "#fd9903" }} />
      </div>
    )
  }
